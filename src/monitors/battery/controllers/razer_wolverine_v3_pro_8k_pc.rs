...
pub(in crate::monitors::battery) struct BatteryState {
    pub(in crate::monitors::battery) level: Option<u8>,
    pub(in crate::monitors::battery) charging: bool,
    pub(in crate::monitors::battery) connected: bool,
}
...
pub(in crate::monitors::battery) fn query() -> Result<Option<BatteryState>, String> {
