...
//!
//! These bounds are used by legacy/mod.rs to handle click events.

use cairo;
use pango;
use pangocairo;

use super::drawing::draw_temp_circle;
use super::drawing::draw_weather_icon;
use super::drawing::{draw_cpu_icon, draw_gpu_icon, draw_progress_bar, draw_ram_icon};
use super::theme::CosmicTheme;
use crate::config::WidgetSection;
use crate::monitors::battery::BatteryDevice;
use crate::monitors::media::{AlbumArt, MediaInfo};
use crate::monitors::notifications::Notification;
...

    {
        ...
        for section in params.section_order {
            match section {
                ...
                // Codex usage is provided by the production Iced overlay only.
...
fn render_media(
    ...
    use crate::monitors::media::PlaybackStatus;
