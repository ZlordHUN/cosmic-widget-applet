...
fn is_overlay_target(target: &str) -> bool {
    target == "cosmic_widget_applet" || target.starts_with("cosmic_widget_applet::")
}
...
mod tests {
    ...
    fn logging_keeps_overlay_targets_and_rejects_dependencies() {
        assert!(is_overlay_target("cosmic_widget_applet"));
        assert!(is_overlay_target("cosmic_widget_applet::overlay"));
        assert!(is_overlay_target("cosmic_widget_applet::monitors::media"));
        assert!(!is_overlay_target("cosmic_widget_applet_other"));
